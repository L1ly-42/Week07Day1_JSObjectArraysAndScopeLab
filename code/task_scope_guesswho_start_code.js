...
// const guess2 = `Guess Who is ${firstName}`; // Prediction: Liz
...
// const finalAnswer = guessWho(); 
// console.log(finalAnswer);       // Prediction:  Chris
...
// const finalAnswer = guessWho(); //Prediction: 'Guess Who is Gail'
// console.log(finalAnswer);
...
// changeGuess();
// console.log(`Guess Who is ${guess.firstName}`); // Prediction: error due to trying to completely reassign a constant variable
